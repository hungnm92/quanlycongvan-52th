...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            ...
            griTimTheoTen.DataSource = cv.TimTongHop(int.Parse(Session["MaLCV"].ToString()), int.Parse(Session["MaTT"].ToString()), Session["TenCV"].ToString(), int.Parse(Session["Thang"].ToString()));
