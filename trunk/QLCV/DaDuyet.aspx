<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DaDuyet.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table style="width:100%;">
        ...
        <tr>
            <td style="font-weight: 700; font-size: 20px; text-align: center; color: #FFFFFF; background-image: none;">
                <asp:GridView ID="griDaDuyet" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Font-Bold="False" DataKeyNames="So" OnSelectedIndexChanged="griDaDuyet_SelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="griDaDuyet_PageIndexChanging" OnRowCommand ="griDaDuyet_RowCommand">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ThoiGianDuyet" HeaderText="Ngày duy&#7879;t" />
