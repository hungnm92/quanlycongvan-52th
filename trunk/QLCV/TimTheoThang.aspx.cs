...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            ...
            griTimTheoThang.DataSource = cv.TimTheoThang(int.Parse(Session["Thang"].ToString()));
            griTimTheoThang.DataBind();
    ...
    {
        griTimTheoThang.Visible = false;
        pnlChiTiet.Visible = true;
        cut.So = int.Parse(griTimTheoThang.SelectedValue.ToString());
        cut.CT();
    ...
    {
        griTimTheoThang.PageIndex = e.NewPageIndex;
        griTimTheoThang.DataSource = cv.TimTheoThang(int.Parse(Session["Thang"].ToString()));
        griTimTheoThang.DataBind();
    }
