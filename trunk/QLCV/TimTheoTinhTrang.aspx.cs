...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            ...
            griTimTinhTrang.DataSource = cv.TimTinhTrang(int.Parse(Session["MaTT"].ToString()));
            griTimTinhTrang.DataBind();
    ...
    {
        griTimTinhTrang.Visible = false;
        pnlChiTiet.Visible = true;
        cut.So = int.Parse(griTimTinhTrang.SelectedValue.ToString());
        cut.CT();
    ...
    {
        griTimTinhTrang.PageIndex = e.NewPageIndex;
        griTimTinhTrang.DataSource = cv.TimTinhTrang(int.Parse(Session["MaTT"].ToString()));
        griTimTinhTrang.DataBind();
    }
