                ...
                <table style="width:100%; height: 56px;" __designer:mapid="59">
                    <tr __designer:mapid="5a">
                        ...
                        <td class="auto-style81" __designer:mapid="5d">
                            <asp:TextBox ID="txtNguoiNhan" runat="server" TextMode="MultiLine" Width="254px" Height="77px"></asp:TextBox> <asp:Button ID="btnXongNguoiNhan" runat="server" Text="Button" OnClick="btnXongNguoiNhan_Click" />
                                        <asp:Panel ID="pnlNguoiNhan" CssClass="PnlDesign" runat="server">
